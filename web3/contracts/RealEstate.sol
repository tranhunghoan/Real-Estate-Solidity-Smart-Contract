...
contract RealEstate {
    ...
    address payable contractOwner =
        payable(0x9c567d11dEE6BAe3Acc5840678ECeE650F2c148f);
    ...
    {
        require(price > 0, "Price must be geater than zero.");
        ...
        property.propertyTite = _propertyTitle;
    ...
    function buyProperty(uint256 id, address buyer) external payable {
        ...
        require(amount == properties[id].price, "Insufficient fund");
    ...
    function addReview(
        ...
        products[productId].numberReviews++;
    ...
    function getHighestRatedProduct() external view returns (uint256) {
        ...
        for (uint256 i = 0; i < reviewsCounter; i++) {
            ...
            if (products[productId].numberReviews > 0) {
